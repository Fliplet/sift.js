# This is a Fliplet maintained fork of Sift.js with additional features

List of features added by Fliplet:

- Non strict comparison
- Added `$like/$iLike` operator
- Added `$match` operator to allow for Object matching
